...
<head>
    ...
    <!-- TITLE OF SITE -->
    <title>About | Rohini Fernandes - Training you to be your dog’s trainer</title>
		...
		<div class="row">
			<div class="col-md-8">
				...
				<article>
					...
					<ul>
						<li><p><i class="icon-prize-award"></i> Rohini was nominated as MTV Youth Icon of the year 2008.</p></li>
						<li><p><i class="icon-prize-award"></i> She was also nominated for the TATA NEN Startups Awards 2008. Her organization was ranked 241 from 600 different startup companies in India!</p></li>
